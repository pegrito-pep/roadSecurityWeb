<template>
  <div class="container-fluid">
            ...
            <div class="d-block d-md-inline-block">
              ...
              <div class="search-sm d-inline-block float-md-left mr-1 mb-1 align-top">
                <form action class>
                  ...
                  ></button>
                  <div
                    class="adv-search-wrap dropdown-menu dropdown-menu-right"
                    aria-labelledby="adv_wrap_toggler"
                    x-placement="bottom-end"
                    style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(196px, 30px, 0px);"
                  >
          ...
          <table class="table table-bordered table-dark table-striped">
            ...
            <tbody>
              <tr v-for="(user, index) in proprietaires" :key="index">
                ...
                <td v-text="user.permis"></td>
                <!--<td v-text="user.vehicules[0].code"></td>-->
                <td v-for="(vehicule, v) in user.vehicules" :key="v">
                  <span>{{ vehicule.code }}</span><span v-if="v!==(user.vehicules.length-1)">,</span>
                </td>
                <td>
    ...
    <proprietaire-detail v-if="show" v-bind:usager="user" />
  </div>
</template>
<script>
import ProprietaireDetail from "@/views/taximans/ProprietaireDetail.vue";

export default {
  name: "ListProprietaires",
  components: {
    ProprietaireDetail
  },
  data: () => ({
