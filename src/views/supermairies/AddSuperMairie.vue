                ...
                <div class="modal-body">
                    <div>
                        <form-wizard  title='' subtitle='' nextButtonText='suivant' backButtonText='Précedent' finishButtonText='Enregistrer' aria-labelledby="demoModalLabel"  @on-complete="onComplete"
                                        ...
                                        shape="circle"
                                        color="#e74c3c">
                            <tab-content title="Informations Communauté Urbaine"
                                        icon="fa fa-city" 
                                        :before-change="validateAsync">
                            <div class="form-group">
                                <label for="exampleInputUsername1">Nom Communauté Urbaine</label>
    ...
    methods:{
        ...
        onComplete(){
            ...
            axios.post("supers-mairies",data).then(response =>{
                ...
                this.$root.$emit("new-super-mairie-added", response.result);
            })
