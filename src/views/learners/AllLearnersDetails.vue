            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="col-md-6"><img src="/img/childsRights4.jpg" class="img-fluid" alt=""></div>
                            <div class="col-md-6"><img src="/img/childsRights5.jpg" class="img-fluid" alt=""></div>
                        </div>
